...
class BaseOptions:
    ...
    def parse(self, verbose=True):
        ...
        # some derived options used by segmentation metrics
        ...
        # set gpu ids safely (CPU-only friendly)
        ...
        if torch.cuda.is_available() and len(gpu_ids) > 0:
            ...
            opt.gpu_ids = []
            if verbose:
                print("WARNING: CUDA not available or gpu_ids < 0. Running on CPU only.")
